...
repeat_choosing:
cout << "Choose your service!" << endl << "1.Input students' info." << endl << "2.Input additional students." << endl << "3.Search student by ID" << endl << "4.Update student's info by ID" << endl << "5.Output all students' info" << endl;
cout << "6.Sort and output students' info" << endl << "7.Ouput best student" << endl << "8.Exit" << endl;
cin >> mode;
switch(mode){
	case 1:
	...
	if(input_check == false){
		...
		for (int i = 0; i < size; i++){
			if(students[i].id == update_by_ID){
				found = true;
				another_option:
				cout << "Choose which element to update:" << endl << "1.Name" << endl << "2.Age" << endl << "3.Gender"<< endl;
				cout << "4.Mathematics score" << endl << "5.Chemistry score" << endl << "6.Physics score" << endl << "7.Exit" << endl;
				int update_mode;
				cin >> update_mode;
				switch (update_mode)
				{
